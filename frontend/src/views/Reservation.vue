...
export default {
  ...
  data() {
    return {
      ...
      rooms: [
        { value: 'RoomA', label: 'roomA' },
        { value: 'RoomB', label: 'roomB' },
        { value: 'RoomC', label: 'roomC' }
      ],
      seats: [
        { value: 'Seat1', label: 'seat1' },
        { value: 'Seat2', label: 'seat2' },
        { value: 'Seat3', label: 'seat3' }
      ]
    }
  },
  methods: {
    onSubmit() {
      console.log('Reservation Form Submitted:', this.reservationForm)
      // TODO: Connect with your API to process the reservation
    }
  }
}
</script>

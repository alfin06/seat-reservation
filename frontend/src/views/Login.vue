<template>
  <div class="auth-form">
    ...
    <div v-else class="qr-login">
      ...
      <div class="qr-box">
        <!-- You can replace the src with your generated QR code image -->
...
export default {
  data() {
    return {
      ...
      password: '',
      loginMode: 'form',
      qrCodeUrl: 'https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=login-session-token' // Example QR code
    }
  },
  methods: {
    handleLogin() {
